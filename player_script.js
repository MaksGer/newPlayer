...
//     },
//     John: {
//         info : "Информация для биографии исполнителя2.",
//         defaultInfo : "Извините, но статья по данному исполнителю временно не доступна.",
//         audio : {
//             song2: {
//                 link: "song2.mp3",
...
//     playlist[0] = {
//         //Имя исполнителя
//         performer: musicDataBase[0],
//         //Название композиции
//         soundName : musicDataBase[0].Alex.audio
//     },
//     playlist[1] = {
//         //Имя исполнителя
//         performer: musicDataBase[1],
//         //Название композиции
//         soundName : musicDataBase[1].John.audio
//     },
//     playlist[2] = {
//         //Имя исполнителя
//         performer: musicDataBase[1],
...
//Построим плейлист
    ...
    for (i = 0; i < playlist.length; i++) {
        ...
        note.classList.add('song_item');
        note.innerHTML = `${playlist[i].performer} - ${playlist[i].soundName} <button>info</button>`;
        dom.wrapper.appendChild(note);
    };
//построение trackUrls из плейлиста
for (i = 0; i < playlist.length; i++) {
    trackUrls.push(playlist[i].link);
}
...
let offsetTop = function(node) {
    ...
    let songs = document.querySelectorAll(".song_item");
